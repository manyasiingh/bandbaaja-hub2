...
/**
 * Table class for categoryreport
 */
class categoryreport_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'categoryreport_base';
		...
		// category_id
		$this->category_id = new ReportField('categoryreport_base', 'categoryreport', 'x_category_id', 'category_id', '`category_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// category_name
		$this->category_name = new ReportField('categoryreport_base', 'categoryreport', 'x_category_name', 'category_name', '`category_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`categoryreport`";
	}
