...
/**
 * Table class for userreport
 */
class userreport_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// user_id
		$this->user_id = new ReportField('userreport_base', 'userreport', 'x_user_id', 'user_id', '`user_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// user_name
		$this->user_name = new ReportField('userreport_base', 'userreport', 'x_user_name', 'user_name', '`user_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_name->Sortable = TRUE; // Allow sort
		$this->user_name->DateFilter = "";
		$this->fields['user_name'] = &$this->user_name;

		// user_gender
		$this->user_gender = new ReportField('userreport_base', 'userreport', 'x_user_gender', 'user_gender', '`user_gender`', 201, -1, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->user_gender->Sortable = TRUE; // Allow sort
		$this->user_gender->DateFilter = "";
		$this->fields['user_gender'] = &$this->user_gender;

		// user_address
		$this->user_address = new ReportField('userreport_base', 'userreport', 'x_user_address', 'user_address', '`user_address`', 201, -1, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->user_address->Sortable = TRUE; // Allow sort
		$this->user_address->DateFilter = "";
		$this->fields['user_address'] = &$this->user_address;

		// user_date_of_birth
		$this->user_date_of_birth = new ReportField('userreport_base', 'userreport', 'x_user_date_of_birth', 'user_date_of_birth', '`user_date_of_birth`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_date_of_birth->Sortable = TRUE; // Allow sort
		$this->user_date_of_birth->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $ReportLanguage->phrase("IncorrectDate"));
		$this->user_date_of_birth->DateFilter = "";
		$this->fields['user_date_of_birth'] = &$this->user_date_of_birth;
	}
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`userreport`";
	}
