...
/**
 * Page class (categoryreport_rpt)
 */
class categoryreport_rpt extends categoryreport_base
{
	...
	// Page object name
	public $PageObjName = 'categoryreport_rpt';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (categoryreport_base)
		if (!isset($GLOBALS["categoryreport_base"])) {
			$GLOBALS["categoryreport_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["categoryreport_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'categoryreport');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fcategoryreportrpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fcategoryreportrpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcategoryreportrpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fcategoryreportrpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
