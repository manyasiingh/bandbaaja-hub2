...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'RUlGGASNpooE5nwF'); // Random key for encryption
...
$PROJECT_ID = "{745C173A-EC88-4AAB-A8CD-A6A681354D9F}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "wedding_old", "qs" => "`", "qe" => "`");
