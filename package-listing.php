...
<body>
    ...
    ?>
    <div class="page-header" style="background: url('pacakage_image/background_1.webp');">
        <div class="container">
            <div class="row">
                <!-- page caption -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                if (isset($_GET['category_id'])) {
                    $q = mysqli_query($connection, "SELECT * FROM `tbl_package` WHERE `category_id` = '{$_GET['category_id']}'");
                } else {
