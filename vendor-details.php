...
session_start();
$q = mysqli_query($connection, "SELECT * FROM `tbl_vendor` where vendor_id = '{$_GET['vendor_id']}'");
                ...
                <div class="row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">About Vendor</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="content">
        <div class="container">
            <div class="card border card-shadow-none">
                <h3 class="card-header bg-white">About <?php echo $data['vendor_name'] ?></h3>
                <div class="card-body">
                    <div class="venue-highlights">
                        <div class=" table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col" colspan="2"><?php echo $data['vendor_name'] ?> Highlights</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Contact Number</td>
                                        <td class="venue-highlight-meta"><?php echo $data['vendor_contact_no'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td class="venue-highlight-meta"><?php echo $data['vendor_email'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Category</td>
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <?php
                                $q = mysqli_query($connection, "SELECT * FROM `tbl_package` WHERE `vendor_id` = '{$_GET['vendor_id']}'");
