...
{
        echo "<td>{$row['user_id']} </td> <td>{$row['user_name']} </td> <td>{$row['user_gender']} </td><td>{$row['user_email']} </td> <td>{$row['user_password']} </td><td>{$row['user_address']} </td><td>{$row['user_date_of_birth']} </td>";
		echo "<td><a href = '?did={$row['user_id']}'>Delete</a></td>";
        echo "</tr>";
} 
    echo "</table>"; 
