							...
							<div class="form-body">
								<form data-toggle="validator" id="myform" method="post">
									...
									<div class="form-group has-feedback">
										Feedback Details<input type="text" name="txt1" class="form-control" id="inputEmail" placeholder="Enter feedback details" data-error="Bruh, that email address is invalid" required>
									</div>
